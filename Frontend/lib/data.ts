...
export type PillKind = "blue" | "orange" | "yellow" | "red" | "green" | "gray";
...
export type EstadoPedido = "transito" | "entregado" | "pendiente" | "anulado";
...
export type ProgEstado = "confirmada" | "programada" | "tentativa";
...
export type PagoEstado = "rechazado" | "confirmado" | "empacado";
...
export type Plataforma = "CREATED" | "NOT_AUTHORIZED" | "OK";
...
export type FactEstado = "vigente" | "porvencer" | "vencida";
...
export type Firma = "ok" | "pend";

export interface DocRemision {
  id: string;
  emision: string;
  tipo: string;
  pedido: string;
...
// Cupo / cartera
const cupo: Cupo = { total: 800000000, utilizado: 512000000, disponible: 288000000 };
...
const puntos: string[] = ["Bodega principal", "Patio de descargue 2", "Obra Norte – Torre A", "Centro de acopio"];
const conductores: string[] = ["Arturo Mosquera", "Jhon Camilo Mena", "Andrés Vélez", "Por asignar"];
...
const programacion: ProgramacionDia[] = [
...
const progEstados: Record<ProgEstado, EstadoMeta> = {
...
const platEstados: Record<Plataforma, PillKind> = {
